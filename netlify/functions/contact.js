export default async (req) => {
  ...
  async function sendViaZepto({ to, subject, text, html, replyTo }) {
  ...
  <p><strong>EN</strong>: Hi ${name},<br>
  Thanks for your message — I received it and I’ll reply within 24–48 hours.<br>
  — CraftLab Studio</p>

  <hr style="border:none;border-top:1px solid #333;opacity:.2">

  <p><strong>ES</strong>: Hola ${name},<br>
  Gracias por tu mensaje — lo he recibido y te responderé en 24–48 horas.<br>
  — CraftLab Studio</p>

  <hr style="border:none;border-top:1px solid #333;opacity:.2">

  <p><strong>IT</strong>: Ciao ${name},<br>
  Grazie per il tuo messaggio — l’ho ricevuto e ti risponderò entro 24–48 ore.<br>
  — CraftLab Studio</p>
</div>
`;
